...
export type BarPrintJob={id:string;storeId:string;tableNumber:string;sourceBillId?:string;items:BarPrintJobItem[];createdById?:string;createdByName?:string;status:BarPrintJobStatus;createdAt?:ApiTimestamp;printedAt?:ApiTimestamp;printedByTerminal?:string};
