...
export const companyFaqs = [
  ...
  },
  {
    ...
    answer:
      "Trang web phù hợp để xem nhanh thông tin doanh nghiệp, địa chỉ, giờ hoạt động, mô tả không gian, hình ảnh thực tế và định hướng trải nghiệm của từng điểm trong hệ sinh thái Ông Quan.",
  },
];

export const venueSeoContentById = {
  cafe: {
    sections: [
      {
        title: "Quán cà phê Cần Thơ cho gặp gỡ và chụp ảnh",
        paragraphs: [
          "Tiệm cà phê Ông Quan được định vị như một quán cà phê Cần Thơ có nhiều khu không gian khác nhau, phù hợp cho gặp gỡ bạn bè, hẹn khách, làm việc nhẹ hoặc tìm một địa điểm chụp ảnh cuối tuần.",
          "Điểm mạnh của quán là cảm giác thay đổi trải nghiệm theo từng khu. Khách có thể chọn góc ấm hơn để nói chuyện, khu gần thiên nhiên để thư giãn hoặc không gian riêng tư hơn cho các buổi gặp gỡ thân mật.",
        ],
      },
      {
    ...
    faqs: [
      {
        question: "Tiệm cà phê Ông Quan phù hợp với nhóm khách nào?",
        answer:
          "Quán phù hợp với khách đi nhóm bạn, cặp đôi, gia đình nhỏ hoặc người cần một quán cà phê Cần Thơ có nhiều không gian để chọn theo mục đích gặp gỡ, trò chuyện hoặc chụp ảnh.",
      },
      {
        question: "Điểm nổi bật của Tiệm cà phê Ông Quan là gì?",
        answer:
          "Điểm nổi bật là quán có nhiều khu trải nghiệm khác nhau như Hội An, nhà bên suối và nhà gia tiên, giúp khách có cảm giác thay đổi không gian trong cùng một điểm đến.",
      },
    ],
  },
  hotpot: {
  ...
  farm: {
    sections: [
      {
        title: "Địa điểm tham quan và check-in tại Cần Thơ",
        paragraphs: [
          "Ông Quan Farm được định vị như một địa điểm tham quan tại Cần Thơ dành cho gia đình, nhóm bạn và khách muốn tìm không gian ngoài trời để dạo chơi, chụp ảnh và trải nghiệm cuối tuần.",
          "Thay vì chỉ là khu canh tác đơn thuần, farm tập trung vào trải nghiệm tham quan với các khu thú, góc check-in và không gian mở, phù hợp với những truy vấn như farm tham quan Cần Thơ hoặc điểm đi chơi cuối tuần cho gia đình.",
        ],
      },
      {
        title: "Phù hợp khách đi gia đình và nhóm nhỏ",
        paragraphs: [
          "Với khung giờ tham quan ban ngày, nhiều khu ngoài trời và các điểm dừng chụp ảnh, Ông Quan Farm phù hợp cho khách đi cùng trẻ nhỏ, nhóm bạn thích trải nghiệm gần thiên nhiên hoặc khách cần một địa điểm thư giãn khác với mô hình quán ăn uống thông thường.",
          "Trang này giúp người dùng xem nhanh các khu nổi bật, hình ảnh thực tế và thông tin liên hệ trước khi quyết định ghé farm, đồng thời làm rõ chủ đề tham quan cho công cụ tìm kiếm.",
        ],
      },
    ],
    faqs: [
      {
        question: "Ông Quan Farm phù hợp với ai?",
        answer:
          "Farm phù hợp với gia đình có trẻ nhỏ, nhóm bạn muốn tham quan và chụp ảnh, hoặc khách đang tìm một địa điểm ngoài trời tại Cần Thơ để đi chơi cuối tuần.",
      },
      {
        question: "Ông Quan Farm là nông trại sản xuất hay điểm tham quan?",
        answer:
          "Ông Quan Farm được giới thiệu theo hướng điểm tham quan trải nghiệm, nổi bật ở khu thú, góc check-in và không gian ngoài trời hơn là mô hình canh tác thuần túy.",
      },
    ],
  },
};
