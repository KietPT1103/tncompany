...
export default function BillsPage() {
  ...
  const virtualGeneratedLineCount = virtualBillRows.length;
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="rounded-lg border border-amber-200 bg-amber-50 px-3 py-2 text-sm text-amber-900">
                    Không lưu vào DB. Hệ thống chỉ sinh bill tạm theo đúng tổng doanh thu và số
                    bill bạn nhập.
                  </div>
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="space-y-1">
                        ...
                        <p className="text-xs text-slate-500">
                          Mặc định là nhập tay. Excel đọc chính xác hơn, PDF hiện dùng để gợi ý số
                          doanh thu.
                        </p>
              ...
              <Card className="overflow-hidden">
                <CardHeader className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                  <div>
                    ...
                    <p className="text-sm text-slate-500">
                      Hiển thị theo từng dòng món giống cấu trúc bill xuất ra.
                    </p>
                  </div>
                  <div className="flex flex-wrap items-center gap-2">
                    <Button
                    ...
                    <>
                      <div className="grid grid-cols-1 gap-3 xl:grid-cols-3">
                        ...
                        <div className="rounded-lg border border-sky-100 bg-sky-50 px-4 py-3">
                          ...
                          <p className="text-2xl font-bold text-sky-900">{virtualGeneratedLineCount}</p>
                        </div>
                      </div>
                        ...
                        <table className="w-full text-sm">
                          ...
                          <tbody className="divide-y">
                            {virtualBillRows.map((row, index) => (
                              <tr key={`${row.billCode}-${row.productCode}-${index}`} className="hover:bg-slate-50">
