    ...
    public function ingest(array $items, array $options = []): array
    {
        ...
        foreach ($items as $item) {
            ...
            $processedRows[] = [
                ...
                'search_id' => $this->nullableString($item['search_id'] ?? $item['searchId'] ?? null),
                'keyword' => $this->nullableString($item['keyword'] ?? null),
                'comment_id' => $commentId,
                'video_id' => $videoId,
                'author_name' => $this->nullableString($item['author_name'] ?? $item['authorName'] ?? null),
                'username' => $this->nullableString($item['username'] ?? $item['author_name'] ?? $item['authorName'] ?? null),
                'video_username' => $this->nullableString($item['video_username'] ?? $item['videoUsername'] ?? null),
                'video_url' => $this->nullableString($item['video_url'] ?? $item['videoUrl'] ?? null),
                'share_url' => $this->nullableString($item['share_url'] ?? $item['shareUrl'] ?? null),
