...
CREATE TABLE IF NOT EXISTS ingredients (
  ...
  purchase_to_base_factor DECIMAL(15,6) NOT NULL DEFAULT 1,
  conversion_source_ingredient_id VARCHAR(64) NULL,
  conversion_input_quantity DECIMAL(15,6) NULL,
  conversion_output_quantity DECIMAL(15,6) NULL,
